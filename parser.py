...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        type=float,
        default=None,
        help="L2 distance threshold for determining positive predictions (lower distance = higher confidence). "
        "If None, uses adaptive threshold based on distance distribution.",
    )
